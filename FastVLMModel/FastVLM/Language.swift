...
private enum Language {
    ...
    nonisolated fileprivate class Attention: Module {
        ...
        nonisolated public init(_ args: FastVLMConfiguration.TextConfiguration) {
    ...
    nonisolated fileprivate class MLP: Module, UnaryLayer {
        ...
        nonisolated public init(dimensions: Int, hiddenDimensions: Int) {
...
nonisolated public class FastVLMProcessor: UserInputProcessor {
...
nonisolated private class FastVLMMultiModalProjector: Module, UnaryLayer {
    ...
    nonisolated public init(_ config: FastVLMConfiguration) {
...
nonisolated public class FastVLM: Module, VLMModel, KVCacheDimensionProvider {
    ...
    public var loraLayers: [Module] {
        languageModel.model.layers.map(\.attention)
    }
